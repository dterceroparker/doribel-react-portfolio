  ...
  return (
    <section id="about" className="max-w-4xl mx-auto p-4 py-16">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-8">
        <div className="relative w-56 h-56 overflow-hidden flex justify-center items-center rounded-full border-4 border-gray-200 hover:scale-110 transition-transform duration-300">
          <img 
            src="/logo.png" 
            alt="Logo" 
            className="w-48 h-48 rounded-full object-cover shadow-lg transition-transform duration-300 transform hover:scale-110"
          />
        </div>
